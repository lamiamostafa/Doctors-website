...
const Blogs = () => {
    return (
        <div>
            ...
            <p> Authentication is the process of verifying who a user is. On the Otherhand ,Authorization is the process of verifying what they have access to.Authentication is done before the authorization process, whereas authorization process is done after the authentication process.In authentication process, the identity of users are checked for providing the access to the system.A common example for athentication  process is  entering a username and password when you log in to a website A good example for authorization is house ownership.</p>
            <h5>Why are you use Firebase? what other options do you have to implement authentication?</h5>
            <p>We use Firebase as its Database capabilities is robust.Fireabase has a Wide number of services and it is fully free also.Accessible UI and ease of integration, Concise documentation , Static hosting capabilities.
